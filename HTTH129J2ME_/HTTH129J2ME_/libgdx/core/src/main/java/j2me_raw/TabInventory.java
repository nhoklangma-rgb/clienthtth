public final class TabInventory extends MainTabShop {
   ...
   public final void commandPointer(int index, int subIndex) {
      ...
      case 31:
         ...
         if (super.itemCur != null) {
            var9 = (MainItem)GameScreen.player.LR.get("" + super.itemCur.BR);
            if (subIndex == 0) {
               CZ = var9.LvUpgrade;
   ...
   private static void AC(mVector var0) {
      ...
      for(int var1 = 0; var1 < var0.size(); ++var1) {
         MainItem var2;
         if ((var2 = (MainItem)var0.elementAt(var1)).typeObject == 3 && var2.colorName == 0 && var2.BR >= 0 && var2.BR <= 5) {
            IS.addElement(var2);
         }
      }
   ...
   private static void AD(mVector var0) {
      ...
      for(int var1 = 0; var1 < var0.size(); ++var1) {
         MainItem var2;
         if ((var2 = (MainItem)var0.elementAt(var1)).typeObject == 3 && (var2.colorName == 0 || var2.colorName == 1) && var2.BR >= 0 && var2.BR <= 5) {
            IS.addElement(var2);
         }
      }
   ...
   public final void AO() {
      CZ = 0;
      if (super.itemCur == null || super.itemCur.typeObject != 3 || super.itemCur.BP != GameScreen.player.clazz && super.itemCur.BP > 0) {
         if (super.BU != null) {
            super.BU.setPos(-50, -50, AvMain.fraPlus, "");
         }

      } else {
         MainItem var1 = (MainItem)GameScreen.player.LR.get("" + super.itemCur.BR);

public final class Class_GN extends MainTab {
   ...
   public final void commandPointer(int var1, int var2) {
      ...
      case 8:
         if (this.BP != null) {
            MainItem var3 = (MainItem)GameScreen.player.LR.get("" + this.BP.BR);
            if (var2 == 0) {
      ...
      if (this.BN == null) {
         ...
         for(var3 = var3; var3 < var7; ++var3) {
            if (var3 >= 0 && var3 < this.BN.size()) {
               ...
               MainItem var5;
               (var5 = (MainItem)this.BN.elementAt(var3)).AA(var1, 2 + MainTab.AE / 2, var2 + MainTab.AE / 2 + 1, MainTab.AE);
   ...
   public final void AG() {
      ...
      if (GameCanvas.isTouch) {
         TabInventory.CZ = 0;
         if (this.BP == null || this.BP.typeObject != 3 || this.BP.BP != GameScreen.player.clazz && this.BP.BP > 0) {
            if (this.BY != null) {
         ...
         MainItem var2 = (MainItem)GameScreen.player.LR.get("" + this.BP.BR);

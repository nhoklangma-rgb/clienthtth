public final class Class_BH extends MainTabShop {
   public static iCommand CD;
   ...
   public Class_BH(String var1, mVector var2, byte var3, int var4) {
   ...
   public final mVector getMenuActionItem() {
      ...
      if ((var2 = (MainItem)super.vecShop.elementAt(super.IdSelect)) != null) {
         ...
         var1 = super.itemCur.AB(super.BS);
         if (super.BS == 103) {

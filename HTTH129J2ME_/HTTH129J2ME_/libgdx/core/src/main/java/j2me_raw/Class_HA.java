public final class Class_HA extends Class_GE {
   public static Class_HA AA;
   private mVector AB = new mVector();
   private int AC = 0;
   private Scroll AD = new Scroll();
   private int AE = 93;

   public Class_HA(mVector var1) {
      super((byte)0, var1, T.VJ, 200, 180);
      ...
      for(int var3 = 0; var3 < super.AY.size(); ++var3) {
         Class_DS var2;
         iCommand var4;
         if ((var2 = (Class_DS)super.AY.elementAt(var3)).BH.AC == 0) {
            var4 = new iCommand(T.DY, 7, var3, this);
         } else if (var2.BH.AC == 1) {
            (var4 = new iCommand(T.BY, 8, var3, this)).AB();
         } else {
            (var4 = new iCommand(T.UB, 9, var3, this)).AC();
         }

         var4.setPos(super.BM + 150, super.BN + super.BH + super.BQ * var3 + 28 + 11, AvMain.fraCmdNhanNapThe, var4.caption);
         this.AB.addElement(var4);
         if (this.AC == 0) {
            this.AC = var4.AL;
         }
      }
      ...
      this.AA(super.AS);
      this.AD.AA(super.BM + super.BO - 20 + super.AV, super.BN + super.BH - 1, super.AR - super.AV, -7967666);
   }
   ...
   public final void commandPointer(int var1, int var2) {
      ...
      case 8:
         super.AW = var2;
         Class_DS var3 = (Class_DS)super.AY.elementAt(super.AW);
         GlobalService.getInstance().AM((byte)1, (short)var3.BH.AB);
      default:
   ...
   public final void AB() {
      ...
      if (super.AY.size() > 0) {
         ...
         if (super.AU != null && !GameCanvas.isTouch) {
            iCommand var3 = (iCommand)this.AB.elementAt(super.AW);
   ...
   public final void AA(mGraphics var1, Class_DS var2, int var3, int var4, int var5, int var6) {
      if (var2 != null) {
         ...
         var1.fillRect(var3, var4, var6, 59);
         var1.setColor(-5271191);
         var1.fillRect(var3 + 2, var4 + 2, var6 - 4, 22);
         AvMain.FontBorderColor(var1, T.QF + " :", super.BM + super.BO / 2 - 2, var4 + 2, 1, (int)1, (int)7);
         mFont.tahoma_7b_black.drawString(var1, Interface_Game.AA(var2.BH.AA) + "K", super.BM + super.BO / 2 + 2, var4 + 2, 0);
         var4 += 11;
         AvMain.AA(var1, T.UG + " " + Interface_Game.AA(var2.BH.AB) + "K" + " " + T.QF, var3 + var6 / 2, var4 + 2, 2, (byte)5);
         if (GameCanvas.isTouch) {
            iCommand var7;
            iCommand var10000 = var7 = (iCommand)this.AB.elementAt(var5);
         ...
         if (super.AW == var5 && var4 - super.AT.AC + 16 > super.BN + super.BH && var4 - super.AT.AC + 16 + 29 < super.BN + super.BH + super.AR - super.AV) {
            var1.AD(var3 + var8, var4, this.AE + 1, super.BQ);
            mGraphics.AC();
            int var9 = this.AE;
            var9 = super.BQ;
            mGraphics.AD();
   ...
   public final void AA(mGraphics var1, int var2, int var3, int var4) {
      ...
      var1.drawRect(var2 - 1, var3 + super.AW * super.BQ, var4 + 1, 60);
   }
   ...
   public final void update() {
      ...
      this.AD.AA(super.AT.AC, super.AT.AD);
   }
   ...
   public final void updatePointer() {
      ...
      for(var1 = 0; var1 < this.AB.size(); ++var1) {
         ...
         ((iCommand)this.AB.elementAt(var1)).AB(super.BM + 150, var2);
      }

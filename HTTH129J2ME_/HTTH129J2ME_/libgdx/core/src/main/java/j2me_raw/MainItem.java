...
public class MainItem {
   ...
   public final void AA(short var1, int var2, byte var3) {
      ...
      this.vecInfo.addElement(new Class_FB(var1, var2, var6, var3));
      this.AE();
   }

   public final void AA(short var1, int var2, byte var3, byte var4) {
      ...
      this.vecInfo.addElement(new Class_FB(var1, var2, var4, var3));
      this.AE();
   }

   public final void addInfo(String var1, byte var2) {
      this.vecInfo.addElement(new Class_FB(-1, 0, var1, var2, (byte)-1));
      this.AE();
   }

   public void AA(String var1, byte var2, byte var3) {
      this.vecInfo.addElement(new Class_FB(-1, 0, var1, var2, var3));
      this.AE();
   }

   public final void AB(String var1, byte var2) {
      this.vecInfo.insertElementAt(new Class_FB(-1, 0, var1, var2, (byte)-1), 0);
      this.AE();
   }
   ...
   public void AA(mGraphics var1, int var2, int var3, int var4) {
      MainImage var5;
      if ((var5 = this.AD()) != null && var5.img != null) {
   ...
   public final void AB(mGraphics var1, int var2, int var3, int var4, int var5) {
      MainImage var6;
      if ((var6 = this.AD()) != null && var6.img != null) {
   ...
   public final void AD(mGraphics var1, int var2, int var3, int var4, int var5) {
      ...
      if (this.BH != null) {
         for(var6 = 0; var6 < this.BH.length; ++var6) {
            var5 = (this.BH[var6] - 44) / 6;
            if (this.BH[var6] >= 324 && this.BH[var6] <= 326) {
               var5 = GameCanvas.gameTick / 5 % 6;
            } else if (this.BH[var6] >= 241 && this.BH[var6] <= 270) {
               var5 = (this.BH[var6] - 241) / 5;
            } else if (this.BH[var6] >= 368 && this.BH[var6] <= 373 || this.BH[var6] >= 362 && this.BH[var6] <= 367 || this.BH[var6] >= 647 && this.BH[var6] <= 682) {
               var5 = 6;
            }
            ...
            if (var5 >= 0 && var5 < AvMain.fraEffItem.nFrame) {
               if ((this.BH[var6] < 241 || this.BH[var6] > 270) && (this.BH[var6] < 368 || this.BH[var6] > 373) && (this.BH[var6] < 647 || this.BH[var6] > 682)) {
   ...
   public static mVector AA(MainItem var0) {
      ...
      if (var0 != null && (var0.BP == GameScreen.player.clazz || var0.BP <= 0) && var0.typeObject == 3) {
         MainItem var2;
         if ((var2 = (MainItem)GameScreen.player.LR.get("" + var0.BR)) != null) {
            for(int var3 = 0; var3 < var0.vecInfo.size(); ++var3) {
               Class_FB var4 = (Class_FB)var0.vecInfo.elementAt(var3);
               boolean var5 = false;
               if (var4.AD >= 0 && var4.AC == Class_FB.AI) {
                  for(int var6 = 0; var6 < var2.vecInfo.size(); ++var6) {
                     Class_FB var7 = (Class_FB)var2.vecInfo.elementAt(var6);
                     if (var4.AD == var7.AD) {
                        ...
                        var1.addElement(new Class_FB(-1, var8, var10, var9, (byte)-1));
                        var5 = true;
                        break;
                     }
                  }
               ...
               if (!var5) {
                  var1.addElement(new Class_FB(-1, 0, "", (byte)0, (byte)-1));
               }
            }
         }
   ...
   public static mVector AA(MainItem var0, int var1) {
      mVector var2 = new mVector();
      if (var0 == null || var0.BP != GameScreen.player.clazz && var0.BP > 0) {
         return null;
      } else {
         MainItem var3;
         if ((var3 = (MainItem)GameScreen.player.LR.get("" + var0.BR)) != null) {
            for(int var4 = 0; var4 < var0.vecInfo.size(); ++var4) {
               Class_FB var5 = (Class_FB)var0.vecInfo.elementAt(var4);
               boolean var6 = false;
               if (var5.AD >= 0 && var5.AC == Class_FB.AI) {
                  for(int var7 = 0; var7 < var3.vecInfo.size(); ++var7) {
                     Class_FB var8 = (Class_FB)var3.vecInfo.elementAt(var7);
                     if (var5.AD == var8.AD) {
                        ...
                        var2.addElement(new Class_FB(-1, var9, var11, var10, (byte)-1));
                        var6 = true;
                        break;
                     }
                  }
               ...
               if (!var6) {
                  var2.addElement(new Class_FB(-1, 0, "", (byte)0, (byte)-1));
               }
            }
         }
   ...
   public static String getDataKichAn(Item var0) {
      String var1;
      if ((var1 = (String)CD.get("" + var0.BE)) == null) {
         CD.put("" + var0.BE, "");
         GlobalService.getInstance().AH((byte)96, (short)var0.BE);
         var1 = "";
      }

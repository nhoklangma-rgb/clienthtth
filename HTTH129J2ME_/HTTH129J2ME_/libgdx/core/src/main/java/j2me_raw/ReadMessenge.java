...
public final class ReadMessenge extends AvMain {
   ...
   public static void ListChar(Message var0) {
      try {
         ...
         for(int var2 = 0; var2 < var1; ++var2) {
            ...
            var9.AA(var0.reader().readShort());
            var9.AB(var0.reader().readShort());
            short var10;
   ...
   public final void Main_char_Info(Message var1) {
      try {
         ...
         GameScreen.player.KO = var1.reader().readShort();
      ...
      if (GameCanvas.currentScreen == GameCanvas.CQ) {
         ...
         try {
            ...
            if (var2 == 0) {
               ...
               GameCanvas.AA((MainDialog)var16);
            } else if (var2 == 2) {
               ...
               GameCanvas.AA((MainDialog)var21);
            }
   ...
   private void update_InVen_Or_Chest(Message var1, mVector var2, byte typeInvenOrChest) {
      try {
               ...
               if (b == 2) {
                  ...
                  if (b == 6) {
                     if (typeInvenOrChest == 100) {
                        ...
                        if (GameCanvas.currentScreen == GameCanvas.CI) {
                           for(int var26 = 0; var26 < GameCanvas.CI.AB.size(); ++var26) {
                              MainTab var7;
                              if ((var7 = (MainTab)GameCanvas.CI.AB.elementAt(var26)).indexIconTab == 7) {
                  ...
                  if (typeInvenOrChest == 100) {
                     ...
                     if (GameScreen.player.Beri != beri) {
                        ...
                        if (GameCanvas.currentScreen != GameCanvas.tabAllScr && GameCanvas.currentScreen != GameCanvas.CI) {
         ...
         if (MainTabShop.CA && (GameCanvas.currentScreen == GameCanvas.tabAllScr || GameCanvas.currentScreen == GameCanvas.CI)) {
   ...
   private static Item GE(Message var0) {
      ...
      try {
         ...
         (var1 = new Item((byte)3, var2, var6, var3, var10)).AA(var7, var4, var9, var13, var5, var8, var21, var27, var14, var15, var16);
         var1.AR = var2;
         var1.AY = var11;
         if (var1.AY == 1) {
            var1.BO = 1;
   ...
   public final void Effect_Obj(Message var1) {
      try {
         ...
         case 0:
               ...
               for(int var14 = 0; var14 < Player.vecInventory.size(); ++var14) {
                  ...
                  if ((var20 = (MainItem)Player.vecInventory.elementAt(var14)).typeObject == 3 && var20.Lv_RQ == GameScreen.player.Lv) {
                     for(int var18 = 0; var18 < var20.vecInfo.size(); ++var18) {
                        Class_FB var21;
                        if ((var21 = (Class_FB)var20.vecInfo.elementAt(var18)).AC == Class_FB.AF) {
                           var21.AB = 4;
                        }
                     }
                  }
            ...
            return;
         case 1:
            if (var6 == GameScreen.player && (GameCanvas.currentScreen == GameCanvas.tabAllScr || GameCanvas.currentScreen == GameCanvas.CI)) {
      ...
      try {
         ...
         for(int var3 = 0; var3 < var1; ++var3) {
            ...
            if (var14 == 0) {
               ...
               var16.AA(var0.reader().readShort());
               var16.AB(var0.reader().readShort());
               var16.hOne = 52;
               var16.wOne = 26;
               if (LoadMap.specMap == 4) {
                  var16.wOne = 100;
         ...
         if ((var1 = var0.reader().readByte()) == 0) {
            ...
            for(int var20 = 0; var20 < var2; ++var20) {
               ...
               for(int var31 = 0; var31 < var30; ++var31) {
                  ...
                  var24.AA(var33, var32, (byte)Class_FB.AI, (byte)1);
               }
               ...
               if (var24.AF > 0) {
                  var24.AB(T.BG + " " + var24.AF + " " + T.bery, (byte)5);
               } else if (var24.AJ > 0) {
                  var24.AB(T.BG + " " + var24.AJ + " " + T.EW, (byte)5);
               }
            ...
            Class_BH var22;
            (var22 = new Class_BH(var13, var17, (byte)107, MainTab.xTab)).CL = false;
            var26.addElement(var22);
            GameCanvas.CI.addVecTab(var26);
            GameCanvas.CI.AE = 0;
            GameCanvas.CI.Show((MainScreen)GameCanvas.gameScr);
            GameCanvas.CI.AD = 1;
            GameCanvas.CI.AF();
            return;
         }
         ...
         if (var1 == 1) {
            ...
            for(int var16 = 0; var16 < var12; ++var16) {
               ...
               for(int var27 = 0; var27 < var23; ++var27) {
                  ...
                  var8.AA(var28, var10, (byte)Class_FB.AI, (byte)1);
               }
            ...
            var17 = new mVector();
            GameCanvas.CI.AF = true;
            (GameCanvas.CO = new TabInventory(T.UT, var14, (byte)6, MainTab.xTab)).AQ();
            var17.addElement(GameCanvas.CO);
            GameCanvas.CI.addVecTab(var17);
            GameCanvas.CI.AE = 0;
   ...
   public final void Shop_NPC(Message var1) {
      try {
         ...
         if (var4 != 4 && var4 != 8) {
            ...
            if (var4 == 3) {
               for(var7 = 0; var7 < var5; ++var7) {
                  ...
                  if (var25 != null) {
                     var25.AF = var10;
                     var25.AB(T.BG + " " + var25.AF + " " + (var20 == 0 ? T.bery : T.EW), (byte)5);
               ...
               for(var7 = 0; var7 < var5; ++var7) {
                  ...
                  if ((var23 = readUpdateMaterial(var1, true)) != null) {
                     if (var23.AF > 0) {
                        var23.AB(T.BG + " " + var23.AF + " " + T.bery, (byte)5);
                     } else {
                        var23.AB(T.BG + " " + var23.AJ + " " + T.EW, (byte)5);
                     }
               ...
               while(true) {
                  ...
                  if (var21 != null) {
                     if (var21.AF > 0) {
                        var21.AB(T.BG + " " + var21.AF + " " + T.bery, (byte)5);
                     } else if (var21.AJ > 0) {
                        var21.AB(T.BG + " " + var21.AJ + " " + T.EW, (byte)5);
                     } else {
                        boolean var19 = false;
               ...
               if (var4 != 103 && var4 != 108) {
                  if (var4 != 105) {
                     if (var4 == 107) {
                        for(var7 = 0; var7 < var5; ++var7) {
                           ...
                           if ((var8 = new Potion(var14, var17, var22, var11, var12)).AF > 0) {
                              var8.AB(T.BG + " " + var8.AF + " " + T.bery, (byte)5);
                           } else if (var8.AJ > 0) {
                              var8.AB(T.BG + " " + var8.AJ + " " + T.EW, (byte)5);
                           }
                     ...
                     for(var7 = 0; var7 < var5; ++var7) {
                        ...
                        if (var15 != null) {
                           if (var15.AF > 0) {
                              var15.AB(T.BG + " " + var15.AF + " " + T.bery, (byte)5);
                           } else if (var15.AJ > 0) {
                              var15.AB(T.BG + " " + var15.AJ + " " + T.EW, (byte)5);
                           } else if (var15.AF == -2) {
                              var15.AB(T.QK, (byte)5);
                           } else if (var15.AF == -1) {
                              var15.AB(T.PJ, (byte)6);
                              var15.colorName = 6;
                           } else if (var15.ID == Player.idFashion && var2 != 114) {
                              var15.AB(T.IX, (byte)4);
                              var15.colorName = 4;
                           } else {
                              var15.AB(T.IV, (byte)1);
                              var15.colorName = 1;
                           }
                  ...
                  for(var7 = 0; var7 < var5; ++var7) {
                     ...
                     if (var9 != null) {
                        if (var9.AF > 0) {
                           var9.AB(T.BG + " " + var9.AF + " " + T.bery, (byte)5);
                        } else if (var9.AJ > 0) {
                           var9.AB(T.BG + " " + var9.AJ + " " + T.EW, (byte)5);
         ...
         if (var2 == 110) {
            GameCanvas.CI.AF = true;
            (GameCanvas.CO = new TabInventory(T.tabInven, Player.AW, (byte)4, MainTab.xTab)).AQ();
            var26.addElement(GameCanvas.CO);
         } else if (var4 != 107) {
         ...
         if (var2 == 99) {
            ...
            GameCanvas.tabInven.AA((byte)1);
            var27 = new Class_BH(var3, var6, var2, MainTab.xTab);
   ...
   public final void List_Quest(Message var1) {
      try {
         ...
         if ((var3 = var1.reader().readByte()) == 0) {
            ...
            GameCanvas.AA((MainDialog)var13);
         }
   ...
   public final void BN(Message var1) {
      try {
         ...
         if ((var14 = MainObject.get_Object((int)var2, (byte)var3)) != null) {
            ...
            var14.AA(var4);
            var14.AB(var1.reader().readShort());
            byte var15;
            ...
            if (var14 == GameScreen.player) {
               if (GameCanvas.currentScreen == GameCanvas.CI) {
                  for(var6 = 0; var6 < GameCanvas.CI.AB.size(); ++var6) {
                     ((MainTab)GameCanvas.CI.AB.elementAt(var6)).AI();
                  }
               }
   ...
   public static void BU(Message var0) {
      try {
         ...
         if (var1 == 23) {
            ...
            GameCanvas.AA((MainDialog)var14);
         }
      } catch (Exception var13) {
         var13.printStackTrace();
      }
   ...
   public static void BZ(Message var0) {
      try {
         ...
         Class_AF var5;
         (var5 = new Class_AF()).AA(var2, (byte)0);
         GameCanvas.AA((MainDialog)var5);
      } catch (Exception var4) {
      }
   }
   ...
   public static void CI(Message var0) {
      try {
         String var1 = var0.reader().readUTF();
   ...
   public final void CK(Message var1) {
      try {
         MainObject var2;
         (var2 = new MainObject()).name = var1.reader().readUTF();
         var2.maxHp = var1.reader().readInt();
         var2.maxMp = var1.reader().readInt();
         var2.Hp = var1.reader().readInt();
         var2.Mp = var1.reader().readInt();
         var2.Lv = var1.reader().readShort();
         var2.KO = var1.reader().readShort();
         short var3 = var1.reader().readShort();
         var2.AA(var3);
         var2.AB(var1.reader().readShort());
         if ((var3 = var1.reader().readShort()) >= 0) {
            var2.clan = new MainClan();
            var2.clan.ID = var3;
            var2.clan.idIcon = var1.reader().readShort();
            String var8 = GameMidlet.AE(var1.reader().readUTF());
            var2.clan.name = var8;
         }

         byte var9;
         short[] var4 = new short[var9 = var1.reader().readByte()];
         ...
         for(var5 = 0; var5 < var9; ++var5) {
            if (var1.reader().readByte() == 1) {
               Item var6 = GE(var1);
               var2.LR.put("" + var5, var6);
               var4[var5] = var1.reader().readShort();
            }
         }
         ...
         var2.MY = var1.reader().readByte();
         GameCanvas.AA((MainDialog)(new Class_AQ(var2)));
      } catch (Exception var7) {
         var7.printStackTrace();
      }
   }
         ...
         if ((var2 = var1.reader().readByte()) == 0) {
            ...
            for(var21 = 0; var21 < var3; ++var21) {
               ...
               if (var13.ID == Player.idFashion) {
                  var13.AB(T.IX, (byte)4);
                  var13.colorName = 4;
               } else {
                  var13.AB(T.IV, (byte)1);
                  var13.colorName = 1;
               }
   ...
   public static void DC(Message var0) {
      try {
         ...
         byte var5 = var0.reader().readByte();
         if (GameCanvas.currentScreen == GameCanvas.CI) {
            for(int var2 = 0; var2 < GameCanvas.CI.AB.size(); ++var2) {
               ((MainTab)GameCanvas.CI.AB.elementAt(var2)).AA(var1, var5);
            }
   ...
   public static void DE(Message var0) {
      try {
         ...
         if ((var5 = MainObject.get_Object((int)var1, (byte)var2)) != null) {
            ...
            if (GameCanvas.currentScreen == GameCanvas.CI) {
               for(var3 = 0; var3 < GameCanvas.CI.AB.size(); ++var3) {
                  ((MainTab)GameCanvas.CI.AB.elementAt(var3)).AI();
               }
            ...
            if (var1 == 0) {
               ...
               if (var1 == 1) {
                  ...
                  if ((var8 = MainItem.getItemVec(var3, var9, Player.vecInventory)) != null) {
                     ...
                     (var14 = new MainItem(var3, var8.ID, var8.idIcon, var4, var1, var8.LvUpgrade)).AX = var8.AX;
   ...
   public static void DV(Message var0) {
      try {
         byte var1;
         short var2;
         if ((var1 = var0.reader().readByte()) == 0) {
            ...
            byte var5 = var0.reader().readByte();
            MainObject var6;
            if ((var6 = MainObject.AC(var3)) == null) {
               GameScreen.addPlayer((MainObject)(new Class_EV(var2, var3, var4, var5)));
            } else {
               var6.AA(var2, var4, var5);
            }
         } else if (var1 == 1) {
            var0.reader().readShort();
            MainObject var12;
            if ((var12 = MainObject.AC(var0.reader().readShort())) != null) {
               var12.isRemove = true;
            }
         }
         ...
         if (var1 == 3) {
            ...
            for(int var13 = 0; var13 < var2; ++var13) {
               ...
               byte var8 = var0.reader().readByte();
               MainItem var16;
               (var16 = new MainItem(var8, var15, var7, var17, (byte)0)).name = var17;
               var16.info = var10;
               if (var0.reader().readByte() == 1) {
                  var16.AB(T.IX, (byte)1);
                  var16.colorName = 1;
               }
               ...
               for(int var18 = 0; var18 < var1; ++var18) {
                  ...
                  var16.AA(var19, var20, (byte)Class_FB.AI, (byte)1);
               }
            ...
            GameCanvas.CI = new TabScreen(MainTab.xTab, (byte)0);
            mVector var14 = new mVector();
            GameCanvas.CI.AF = false;
            (GameCanvas.CO = new TabInventory(T.VV, var11, (byte)7, MainTab.xTab)).AQ();
            var14.addElement(GameCanvas.CO);
            GameCanvas.CI.addVecTab(var14);
            GameCanvas.CI.AE = 0;
            GameCanvas.CI.Show((MainScreen)GameCanvas.gameScr);
            GameCanvas.CI.AD = 1;
            GameCanvas.CI.AF();
         ...
         if (var1 == 4) {
            var2 = var0.reader().readShort();
            (new StringBuffer("action use idIcon ")).append(var2).toString();
            GameCanvas.CO.AA(var2);
            return;
         }
      } catch (Exception var9) {
      }
   ...
   public static void EE(Message var0) {
      try {
         ...
         if (var1 == 1) {
            ...
            GameCanvas.AA((MainDialog)var10);
            return;
         }
   ...
   public final void EI(Message var1) {
      try {
         ...
         if ((var2 = var1.reader().readByte()) == 2) {
            ...
            (GameCanvas.CP = new TabInventory(T.tabInven, Player.vecInventory, (byte)5, var10)).AQ();
            var12.addElement(GameCanvas.CP);
            GameCanvas.CJ.AE = 0;
         ...
         if (var2 == 8) {
            ...
            Class_AF var14;
            (var14 = new Class_AF()).AA(var11, (byte)1);
            GameCanvas.AA((MainDialog)var14);
            return;
         }
   ...
   public static void EP(Message var0) {
      try {
         byte var1 = var0.reader().readByte();
         Player.AT = var0.reader().readShort();
         if (var1 == 0) {
            ...
            for(int var9 = 0; var9 < var8; ++var9) {
               Class_EM var4 = new Class_EM(var0.reader().readShort(), var0.reader().readUTF(), var0.reader().readShort(), var0.reader().readShort());
         ...
         if (var1 == 1) {
            ...
            if (Player.AX != null) {
               for(int var2 = 0; var2 < Player.AX.size(); ++var2) {
                  Class_EM var3;
                  if ((var3 = (Class_EM)Player.AX.elementAt(var2)).AC == var6) {
                     var3.AA = var0.reader().readShort();
                  }
               }

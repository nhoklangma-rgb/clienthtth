public final class MsgUpdateHeart extends ScreenUpgrade {
   ...
   public MsgUpdateHeart() {
      ...
      MainItem var1;
      if ((var1 = (MainItem)GameScreen.player.LR.get("7")) != null && var1.typeSpec == 1) {
         this.CR = var1;
      }
   ...
   public final void paint(mGraphics var1) {
      ...
      if (this.CR != null) {
         ...
         mFont.tahoma_7b_white.drawString(var1, T.RP + this.CR.valueCheTac, super.AE + 10, super.AF + 33 + GameCanvas.hText, 0);
      }
      ...
      if (this.CW != 0 && this.CW != 2) {
         if (this.CW == 1) {
            ...
            if (this.CX >= this.CV.length) {
               ...
               this.CW = 0;
               MainItem var3;
               if ((var3 = (MainItem)GameScreen.player.LR.get("7")) != null && var3.typeSpec == 1) {
                  this.CR = var3;
               }

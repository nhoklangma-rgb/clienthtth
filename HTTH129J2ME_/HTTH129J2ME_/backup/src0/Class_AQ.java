public final class Class_AQ extends MsgDialog {
   ...
   public Class_AQ(MainObject var1) {
      this.AB = var1;
      this.BK = null;
      if (var1 != null) {
   ...
   public final void paint(mGraphics var1) {
      ...
      if (this.AB.Lv == 100) {
         ...
         mFont.tahoma_7_black.drawString(var1, this.AB.Lv + " + " + this.AB.KO / 10 + "," + this.AB.KO % 10 + "%", var3 - 47 + 20, var2, 0);
         var2 += 10;
         var11 = this.AB.KO / 10 * 70 / 100;
      }

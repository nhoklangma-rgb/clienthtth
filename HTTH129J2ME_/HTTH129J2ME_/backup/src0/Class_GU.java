public final class Class_GU extends ChatDetail {
   private iCommand AA;
   private iCommand AB;
   private iCommand AC;
   private iCommand AD;
   ...
   public Class_GU(String var1, byte var2) {
      super(var1, (byte)3);
   }
   ...
   public final void commandPointer(int var1, int var2) {
      ...
      case 1:
         ...
         if (this.AX != null) {
            GlobalService.getInstance().AB((byte)18, this.AX.AC, this.AX.AH, (byte)0);
            return;
         }
         break;
      case 2:
         GameCanvas.end_Dialog();
         if (this.AX != null) {
            GlobalService.getInstance().AB((byte)20, this.AX.AC, this.AX.AH, (byte)0);
            return;
         }
         break;
      case 3:
   ...
   public final void f_() {
      if (super.AT != null && super.AT.getText().length() > 0 && super.AU == 3) {
         GlobalService.getInstance().AB((byte)15, super.AT.getText(), 0, (byte)0);
         super.AT.AB("");
      }

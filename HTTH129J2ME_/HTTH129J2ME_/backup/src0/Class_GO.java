public final class Class_GO extends MainScreen {
   ...
   public final void paint(mGraphics var1) {
      ...
      if (!GameCanvas.lowGraphic) {
         ...
         mFont.tahoma_7b_black.drawString(var1, T.RK, this.AC + this.AA / 2, var2, 2);
      }

      mFont.tahoma_7_yellow.drawString(var1, String.valueOf(GameScreen.player.LvThongThao), this.AC + this.AA / 2 - var3 - 12 + 1, var2 - 5, 2);
      mFont.tahoma_7_white.drawString(var1, String.valueOf(Player.AT), this.AC + this.AA / 2 + var3 + 12 + 1, var2 - 5, 2);
      ...
      if (Player.AX != null) {
         ...
         for(var3 = var3; var3 < var4; ++var3) {
            Class_EM var5 = (Class_EM)Player.AX.elementAt(var3);
            ...
            Interface_Game.AA(var1, this.AC + 80, var2 - 4, this.AA - 90, var5.AA, var5.AB, var6);
            var2 += this.AE;
         }
   ...
   private static void AD(int var0) {
      if (var0 >= 0 && var0 < Player.AX.size()) {
         Class_EM var1 = (Class_EM)Player.AX.elementAt(var0);

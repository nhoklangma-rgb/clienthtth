public final class MsgArea extends MsgDialog {
   private byte[] AA;
   private int AB = 0;
   private int AC;
   private int BB;
   ...
   public final void setinfoChangeArea(byte[] var1, byte var2) {
      this.AA = var1;
      this.BE = var2;
         ...
         if (super.idSelect >= 0 && super.idSelect < this.AA.length) {
            if (this.BE == 0) {
               ...
               if (GameCanvas.currentScreen == GameCanvas.CJ) {
                  var3 = ((MainTab)GameCanvas.CJ.AB.elementAt(GameCanvas.CJ.idSelect)).AU;
               }

   ...
   public final void AA(mGraphics var1, int var2, int var3) {
      ...
      if (this.AF && this.AD > 3) {
         for(var4 = 0; var4 < this.AD; ++var4) {
            ((Class_IR)this.AE.elementAt(var4)).paint(var1, var2 - this.AG + (this.AL + 3) * var4 + this.AL / 2, var3 + this.AL / 2, this.AL);
         }
         ...
         for(var4 = 0; var4 < 3; ++var4) {
            ...
            if ((var5 = (Class_IR)this.AE.elementAt(var4)) != null) {
               var5.paint(var1, var2 + (this.AL + 3) * var4 + this.AL / 2, var3 + this.AL / 2, this.AL);
            }
         }

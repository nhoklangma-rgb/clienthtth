...
public final class Potion extends MainItem {
   ...
   public final mVector getActionInven(byte var1) {
      ...
      if (var1 == 0) {
         ...
         var2.addElement(GameCanvas.tabInvenMarket.cmdSellMarket);
      }
   ...
   public final mVector getActionShop(byte var1) {
      mVector var2 = new mVector();
      if (var1 == 101) {
         var2.addElement(TabShop.CG);
         var2.addElement(TabShop.CF);
      } else if (super.CF) {
         var2.addElement(TabShop.CK);
      } else {
         var2.addElement(TabShop.CE);
      }
   ...
   public final void AD(mGraphics var1, int var2, int var3, int var4) {
      if (super.CF) {
         ...
         super.paint(var1, var2, var3, (int)32);

public final class Class_HB extends Class_GT {
   public static Class_HB AA;
   private ListNew AB;
   private Class_DS AC;
   private iCommand AD;
   ...
   public Class_HB(byte var1, Class_DS var2) {
      super(var1);
      this.AC = var2;
      if (Class_HC.AA.BO > 180) {
         super.BO = Class_HC.AA.BO - 20;
      } else {
         super.BO = Class_HC.AA.BO;
      }

      super.BP = Class_HC.AA.BP;
   ...
   public final void commandPointer(int var1, int var2) {
      switch(var1) {
      case -1:
         Class_HC.AA.Show((MainScreen)GameCanvas.gameScr);
         return;
      case 0:
         GlobalService.getInstance().AI((byte)1, (byte)((byte)this.AC.AG));
      default:
      }
   }
   ...
   public final void paint(mGraphics var1) {
      ...
      AvMain.FontBorderColor(var1, T.EJ, super.BM + super.BO / 2, super.BN + 18, 2, (int)6, (int)5);
      mFont.tahoma_7_black.drawString(var1, T.VF + " " + Interface_Game.AA(this.AC.BH.AB) + " ", var4, var5, 0);

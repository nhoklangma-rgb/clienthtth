...
public final class mFont {
   ...
   public final String[] splitFontArray(String var1, int var2) {
    ...
    public static mFont getFontByColor(int colorName, boolean bold) {
        switch (colorName) {
            case 0: return bold ? mFont.tahoma_7b_black : mFont.tahoma_7_black;
            case 1: return bold ? mFont.tahoma_7b_brown : mFont.tahoma_7b_brown;
            case 2: return bold ? mFont.tahoma_7b_green : mFont.tahoma_7_green;
            case 3: return bold ? mFont.tahoma_7b_red   : mFont.tahoma_7_red;
            case 4: return bold ? mFont.tahoma_7b_yellow: mFont.tahoma_7_yellow;
            case 5: return bold ? mFont.tahoma_7b_violet: mFont.tahoma_7_violet;
            case 6: return bold ? mFont.tahoma_7b_orange: mFont.tahoma_7_orange;
            case 7: return bold ? mFont.tahoma_7b_blue  : mFont.tahoma_7_blue;
            case 8: return bold ? mFont.tahoma_7b_white : mFont.tahoma_7_white;
            default:return bold ? mFont.tahoma_7b_black : mFont.tahoma_7_black;
        }
    }

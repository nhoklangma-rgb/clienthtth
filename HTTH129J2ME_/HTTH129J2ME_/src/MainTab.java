public class MainTab extends AvMain {
   ...
   public static void AA(mGraphics var0, MainItem var1, mVector var2, byte var3, int var4, int var5, int var6, int var7, boolean var8, MainObject var9, int var10) {
      ...
      if (var1.charClass > 0 && var1.charClass <= 5) {
         if (var1.AY == 1) {
            var17 = 0;
            var12 = 2;
         } else {
      ...
      } else if ((var1.isHoanMy != 1 || var1.valueKickAn < 0) && var1.colorName != 9) {
      ...
      if (var1.charClass > 0 && var1.charClass <= 5) {
         var0.drawRegion(AvMain.imgInfoClass, 0, (var1.charClass - 1) * 15, 15, 15, 0, var4 + var6 / 2 + var14 / 2 + var17, var5 + 5, 3);
      }
      ...
      if (var1.mDaKham != null && var1.numLoKham > 0) {
         var5 = (var1.numLoKham - 1) * 22 / 2;

         for(var14 = 0; var14 < var1.numLoKham; ++var14) {
            if (var14 >= var1.numLoKham - var1.AZ) {
            ...
            Potion var19;
            if (var1.mDaKham != null && var14 <= var1.mDaKham.length - 1 && (var19 = Potion.AD(var1.mDaKham[var14])).CR) {
               var19.paint(var0, var4 + var6 / 2 + var14 * 22 - var5, var13 + 10, 20);
            }
         }
      ...
      for(var5 = 0; var5 < var1.vecInfo.size(); ++var5) {
         infoShow var15 = (infoShow)var1.vecInfo.elementAt(var5);
         byte var20 = 0;
         MainImage var16;
         if (var1.valueKickAn > 0 && var5 == 0 && (var16 = ObjectData.getImageAll((short)(var1.valueKickAn + 400), ObjectData.hashImageSkillSmall, (short)4500)) != null && var16.img != null) {
         ...
         if (var1.typeObject == 105 && var1.LvUpgrade > 0 && var5 == var1.vecInfo.size() - 2) {
         ...
         } else if (var15.AC == infoShow.HARDCODE_PAINT_CENTER) {
            AvMain.AB(var15.AB).drawString(var0, var15.AA(), var4 + var20 + var6 / 2, var13, 2);
         } else if (var15.AC == infoShow.AH) {
            var7 = 0;
            if (var10 > 0) {
               var7 = var10;
            } else if (var1 != null) {
         ...
         } else if (var15.AC == infoShow.HARDCODE_INFO_CO_BAN) {
            var7 = 0;
            if (var10 > 0) {
               var7 = var10;
            } else if (var1 != null) {
            ...
            if (var2 != null && var5 < var2.size()) {
               var15 = (infoShow)var2.elementAt(var5);

public final class TabScreen extends MainScreen {
   ...
   private iCommand AI;
   public byte typeCurrent = 0;
   private byte AJ;
   public int idSelect = 0;
   public boolean isShopClan = false;
   public int AG = 0;
   ...
   public final void paint(mGraphics var1) {
      ...
      MainTab.AA(var1, this.AG, this.isShopClan, this.AJ);
      MainTab.AA(var1, this.AG, this.AB, this.idSelect);
   ...
   public final void update() {
      ...
      if (!GameCanvas.isTouch) {
         ...
         } else if (this.typeCurrent == 1 && this.AI.caption != T.AG) {
   ...
   public final void handleKeyPress() {
      if (this.typeCurrent == 0) {
         ...
         if (var1 != this.idSelect) {
            MainTab.BL = 0;
            this.idSelect = AvMain.AA(this.idSelect, this.AB.size() - 1, true);
            this.setTabSelect();
            this.AG();
            this.AC.AB();
         }
   ...
   public final void setTabSelect() {
      this.AC = (MainTab)this.AB.elementAt(this.idSelect);
   }

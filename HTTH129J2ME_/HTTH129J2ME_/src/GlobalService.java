public final class GlobalService extends Cmd_Message {
   ...
   public final void AR(byte var1) {
    ...
    // Nuôi Pet - Feed Pet
    public final void Feed_Pet(short petId) {
        this.init((byte)-80);
        try {
            super.m.writer().writeByte(5); // Type 5 = Feed Pet
            super.m.writer().writeShort(petId);
        } catch (Exception var2) {
            var2.printStackTrace();
        }
    ...
    // Nâng Cấp Pet - Upgrade Pet
    public final void Upgrade_Pet(short petId) {
        this.init((byte)-80);
        try {
            super.m.writer().writeByte(6); // Type 6 = Upgrade Pet
            super.m.writer().writeShort(petId);
        } catch (Exception var2) {
            var2.printStackTrace();
        }
    ...
    // Pet action method for menu system
    public final void PetAction(byte action, short petId) {
        this.init((byte)-80);
        try {
            super.m.writer().writeByte(action);
            super.m.writer().writeShort(petId);

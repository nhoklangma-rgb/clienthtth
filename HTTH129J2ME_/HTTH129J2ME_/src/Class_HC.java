public final class Class_HC extends Class_GE {
   public static Class_HC AA;
   private int AB = 0;
   ...
   public Class_HC(mVector var1, int var2) {
      super((byte)0, var1, T.VF, 200, 180);
      this.AB = var2;
   ...
   public final void commandPointer(int var1, int var2) {
      ...
      case 7:
         ...
         (Class_HB.AA = new Class_HB(super.BL, var3)).Show((MainScreen)GameCanvas.gameScr);
         break;
      case 8:
         super.AW = var2;
         var3 = (Class_DS)super.AY.elementAt(super.AW);
         GlobalService.getInstance().AI((byte)1, (byte)((byte)var3.AG));
         break;
      case 9:
         super.AW = var2;
         var3 = (Class_DS)super.AY.elementAt(super.AW);
   ...
   public final void AA(mGraphics var1, Class_DS var2, int var3, int var4, int var5, int var6) {
      if (var2 != null) {
         ...
         AvMain.AA(var1, T.VF + " " + Interface_Game.AA(var2.BH.AB) + " " + T.EW, var3 + var6 / 2, var4 + 2, 2, (byte)5);
         if (GameCanvas.isTouch) {
            iCommand var7;
   ...
   public final void AB(mGraphics var1) {
      ...
      AvMain.FontBorderColor(var1, T.EW + " :", super.BM + super.BO / 2 - 2, super.BN + 37, 1, (int)1, (int)7);

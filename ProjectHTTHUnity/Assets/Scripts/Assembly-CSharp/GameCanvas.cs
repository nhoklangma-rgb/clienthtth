...
public class GameCanvas : MotherCanvas, IActionListener
{
	...
	{
		(!isLocal) ? new string[4] { "Merry", "Sunny", "Red Force", "Oro Jackson" } : new string[5] { "Merry", "Sunny", "Red Force", "Oro Jackson", "Local" },
		new string[1] { "Global" }
	};
	...
	public static int hardcodeSpeedUp = 0;
